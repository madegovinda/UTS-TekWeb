                            ...
                            <div date-rangepicker class="flex items-center">
                                <div class="relative">
                                    ...
                                    <input name="start" type="text"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block wfull pl-10 p-2.5 "
                                ...
                                <div class="relative">
                                    ...
                                    <input name="end" type="text"
                                        class="bg-gray-50 border border-gray300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block wfull pl-10 p-2.5 "
                    ...
                    <section>
                        <div class="md:flex font-sans pt-8">
                            <div class="md:shrink-0">
                                <img src="https://awsimages.detik.net.id/community/media/visual/2020/08/25/tari-kecak-1_169.jpeg?w=780&q=90"
                                    alt=""
                                    class="h-48 w-full md:h-full md:w-56 inset-0 wfull h-full object-cover rounded-lg"
                                    loading="lazy" />
                            </div>
                            <form class="p-6">
                                ...
                                <div class="flex space-x-4 mb-5 text-sm font-medium">
                                    <div class="flex-auto flex space-x-4">
                                        <button class="h-10 px-6 font-semibold rounded-full hover:bg-blue-600 hover:text-white " type="submit">
                                            Book Now
                                        </button>
                                        <button data-bs-toggle="modal" data-bstarget="#exampleModalLg"
                                            class="h-10 px-6 font-semibold rounded-full border border-slate-200 text-slate-900 hover:bg-violet-600 hover:text-white"
                                            type="button">
                                            Check Availability
                                        </button>
                                    </div>
                        ...
                        <div class=" font-sans pt-8 text-center">
                            <a href="#"
                            class="inline-flex items-center py-2 px-4 text-sm fontmedium text-gray-500 bg-white rounded-lg border border-gray-300 hover:bg-slate-600 hover:text-white">Previous
                            </a>
                            <!-- Next Button -->
                            <a href="#"
                                class="inline-flex items-center py-2 px-4 ml-3 text-sm fontmedium text-gray-500 bg-white rounded-lg border border-violet-600 hover:bg-violet-600 hover:text-white">Next
                            </a>
                        </div>
                    </section>
                </main>
